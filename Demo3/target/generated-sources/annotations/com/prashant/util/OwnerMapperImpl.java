...
public class OwnerMapperImpl implements OwnerMapper {
    ...
    @Override
    public void updateOwnerFromDTO(OwnerDTO ownerDTO, Owner owner) {
        if ( ownerDTO == null ) {
            return;
        }
    ...
    @Override
    public void updateDomesticPetFromDTO(DomesticPetDTO domesticPetDTO, DomesticPet domesticPet) {
        if ( domesticPetDTO == null ) {
            return;
        }
    ...
    @Override
    public void updateWildPetFromDTO(WildPetDTO wildPetDTO, WildPet wildPet) {
        if ( wildPetDTO == null ) {
            return;
        }
